...
@JsonAdapter(HourDeserializer::class)
data class HourlyWeatherData(
    ...
    @field:SerializedName("temp_c") val tempC:String,
    ...
    @field:SerializedName("feelslike_c") val feelslikeC:String,
    ...
    @field:SerializedName("heatindex_c") val heatindexC:String,
    ...
    @field:SerializedName("vis_km") val visKm:String,
    //Chance of rain as percentage
    @field:SerializedName("chance_of_rain") val chanceOfRain:String,
    //Chance of snow as percentage
    @field:SerializedName("chance_of_snow") val chanceOfSnow:String,
    //Wind gust in kilometer per hour
    @field:SerializedName("gust_kph") val gustKph:String,
)
